  ...
  <tr>
    <td style="padding:35px 40px;">
      ...
      <div style="text-align:center;margin:0 0 25px;">
        <a href="${verifyLink}"
           style="display:inline-block;background:linear-gradient(135deg,#1a73e8,#0d47a1);
                  ...
                  padding:16px 40px;border-radius:12px;letter-spacing:0.5px;">
          ✅ অর্ডার নিশ্চিত করুন
        </a>
      </div>
      <p style="color:#888;font-size:12px;text-align:center;margin:0 0 20px;">
        অথবা এই লিংকটি কপি করুন:<br>
        <span style="color:#1a73e8;word-break:break-all;">${verifyLink}</span>
      </p>
      <p style="color:#e53935;font-size:12px;background:#fce4ec;border-radius:6px;padding:10px 15px;margin:0 0 15px;">
        ⏱️ এই লিংকের মেয়াদ: ${expiryMinutes} মিনিট
      </p>` : `
      <!-- Fallback OTP (verify token না থাকলে) -->
      ...
      <p style="color:#e53935;font-size:13px;background:#fce4ec;border-radius:6px;padding:10px 15px;margin:0 0 15px;">
        ⚠️ <strong>এই কোড কাউকে দেবেন না।</strong>
      </p>`}
...
<table width="560" cellpadding="0" cellspacing="0"
  ...
  <!-- Verify Section -->
  <tr>
    <td style="background:#e8f0fe;border-bottom:2px dashed #1a73e8;padding:22px 35px;text-align:center;">
      <p style="color:#333;font-size:14px;font-weight:bold;margin:0 0 5px;">🛒 বিক্রয় নিশ্চিত করুন</p>
      <p style="color:#555;font-size:12px;margin:0 0 18px;"><strong>${customer.shop_name}</strong>-এর বিক্রয় নিশ্চিত করতে বাটনে ক্লিক করুন:</p>
      ...
      <p style="color:#888;font-size:11px;margin:14px 0 0;">
        বাটন কাজ না করলে এই লিংক ব্রাউজারে খুলুন:<br>
        <span style="color:#1a73e8;word-break:break-all;">${verifyLink}</span>
      </p>
      <p style="color:#e53935;font-size:11px;margin:10px 0 0;">⏱️ লিংকের মেয়াদ: ${expiryMinutes} মিনিট</p>
      ` : `
      ...
      <p style="color:#e53935;font-size:12px;margin:12px 0 0;">⚠️ <strong>এই কোড কাউকে দেবেন না।</strong></p>
      `}
    </td>
  </tr>
