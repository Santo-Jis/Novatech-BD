...
// কর্মচারী অনুমোদন (Admin + Manager — Manager শুধু নিজের টিমের)
const canApproveEmployee = allowRoles('admin', 'manager');

// কর্মচারী বরখাস্ত (Admin + Manager — Manager শুধু নিজের টিমের)
const canSuspendEmployee = allowRoles('admin', 'manager');
