...
const CUSTOMER_VERSION_CODE = 18
const CUSTOMER_VERSION_NAME = '1.0.18'
const CUSTOMER_GITHUB_APK_URL = 'https://github.com/Santo-Jis/Novatech-BD/releases/download/customer-v1.0.18/customer-release.apk'
