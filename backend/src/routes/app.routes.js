...
const CUSTOMER_VERSION_CODE = 307
const CUSTOMER_VERSION_NAME = '1.0.307'
const CUSTOMER_GITHUB_APK_URL = 'https://github.com/Santo-Jis/ZovoriX/releases/download/customer-v1.0.307/customer-release.apk'
