...
const CUSTOMER_VERSION_CODE = 51
const CUSTOMER_VERSION_NAME = '1.0.51'
const CUSTOMER_GITHUB_APK_URL = 'https://github.com/Santo-Jis/Novatech-BD/releases/download/customer-v1.0.51/customer-release.apk'
