...
const CUSTOMER_VERSION_CODE = 345
const CUSTOMER_VERSION_NAME = '1.0.345'
const CUSTOMER_GITHUB_APK_URL = 'https://github.com/Santo-Jis/ZovoriX/releases/download/customer-v1.0.345/customer-release.apk'
...
const SR_VERSION_CODE = 1
const SR_VERSION_NAME = '1.0.1'
const SR_GITHUB_APK_URL = 'https://github.com/Santo-Jis/ZovoriX/releases/download/sr-v1.0.1/sr-release.apk'
