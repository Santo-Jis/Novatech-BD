...
const CUSTOMER_VERSION_CODE = 10
const CUSTOMER_VERSION_NAME = '1.0.10'
const CUSTOMER_GITHUB_APK_URL = 'https://github.com/Santo-Jis/Novatech-BD/releases/download/customer-v1.0.10/customer-release.apk'
