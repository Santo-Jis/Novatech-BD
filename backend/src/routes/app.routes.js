...
const CUSTOMER_VERSION_CODE = 86
const CUSTOMER_VERSION_NAME = '1.0.86'
const CUSTOMER_GITHUB_APK_URL = 'https://github.com/Santo-Jis/Novatech-BD/releases/download/customer-v1.0.86/customer-release.apk'
