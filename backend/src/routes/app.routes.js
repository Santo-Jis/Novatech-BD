...
const CUSTOMER_VERSION_CODE = 376
const CUSTOMER_VERSION_NAME = '1.0.376'
const CUSTOMER_GITHUB_APK_URL = 'https://github.com/Santo-Jis/ZovoriX/releases/download/customer-v1.0.376/customer-release.apk'
...
const SR_VERSION_CODE = 8
const SR_VERSION_NAME = '1.0.8'
const SR_GITHUB_APK_URL = 'https://github.com/Santo-Jis/ZovoriX/releases/download/sr-v1.0.8/sr-release.apk'
