...
const CUSTOMER_VERSION_CODE = 385
const CUSTOMER_VERSION_NAME = '1.0.385'
const CUSTOMER_GITHUB_APK_URL = 'https://github.com/Santo-Jis/ZovoriX/releases/download/customer-v1.0.385/customer-release.apk'
...
const SR_VERSION_CODE = 9
const SR_VERSION_NAME = '1.0.9'
const SR_GITHUB_APK_URL = 'https://github.com/Santo-Jis/ZovoriX/releases/download/sr-v1.0.9/sr-release.apk'
