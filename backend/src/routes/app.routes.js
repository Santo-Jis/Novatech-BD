...
const CUSTOMER_VERSION_CODE = 233
const CUSTOMER_VERSION_NAME = '1.0.233'
const CUSTOMER_GITHUB_APK_URL = 'https://github.com/Santo-Jis/ZovoriX/releases/download/customer-v1.0.233/customer-release.apk'
