...
const CUSTOMER_VERSION_CODE = 205
const CUSTOMER_VERSION_NAME = '1.0.205'
const CUSTOMER_GITHUB_APK_URL = 'https://github.com/Santo-Jis/ZovoriX/releases/download/customer-v1.0.205/customer-release.apk'
