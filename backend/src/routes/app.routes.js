...
const SR_VERSION_CODE = 2
const SR_VERSION_NAME = '1.0.2'
const SR_GITHUB_APK_URL = 'https://github.com/Santo-Jis/ZovoriX/releases/download/sr-v1.0.2/sr-release.apk'
