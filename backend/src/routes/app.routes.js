...
const CUSTOMER_VERSION_CODE = 312
const CUSTOMER_VERSION_NAME = '1.0.312'
const CUSTOMER_GITHUB_APK_URL = 'https://github.com/Santo-Jis/ZovoriX/releases/download/customer-v1.0.312/customer-release.apk'
