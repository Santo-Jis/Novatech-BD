...
const CUSTOMER_VERSION_CODE = 41
const CUSTOMER_VERSION_NAME = '1.0.41'
const CUSTOMER_GITHUB_APK_URL = 'https://github.com/Santo-Jis/Novatech-BD/releases/download/customer-v1.0.41/customer-release.apk'
