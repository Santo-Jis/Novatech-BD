...
const CUSTOMER_VERSION_CODE = 220
const CUSTOMER_VERSION_NAME = '1.0.220'
const CUSTOMER_GITHUB_APK_URL = 'https://github.com/Santo-Jis/ZovoriX/releases/download/customer-v1.0.220/customer-release.apk'
