...
const { getReturnReport }  = require('../controllers/return.controller');
...
router.get('/return',   auth, allowRoles('admin','manager','supervisor','asm','rsm','accountant'), getReturnReport);
