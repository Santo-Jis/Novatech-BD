...
const CURRENT_VERSION_CODE = 301          // Main APK — build-apk.yml আপডেট করে
const CURRENT_CUSTOMER_VERSION_CODE = 388   // Customer APK — build-customer-apk.yml আপডেট করে
const CURRENT_SR_VERSION_CODE = 10           // SR APK — build-sr-apk.yml আপডেট করে (প্রথম রিলিজের আগে 0)
