...
export default function TenantList() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h1 className="font-pf-head text-2xl font-semibold text-pf-primary-700">টেন্যান্ট তালিকা</h1>
        <p className="text-pf-text-secondary text-sm mt-1">সব টেন্যান্ট কোম্পানি ও তাদের বর্তমান অবস্থা</p>
      </div>
