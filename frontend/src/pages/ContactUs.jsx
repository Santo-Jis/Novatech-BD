...
import { FiShoppingBag, FiSettings, FiChevronDown, FiPhone, FiMail, FiMessageCircle, FiMapPin, FiClock, FiSend, FiMenu, FiX } from 'react-icons/fi'
    ...
    <div style={{ minHeight: '100vh', background: T.bgBase, fontFamily: T.fontBody, color: T.textPrimary, overflowX: 'hidden' }}>
      ...
      <nav className={`zx-navbar${mobileMenuOpen ? ' zx-menu-open' : ''}`} style={{
        ...
        <div className="zx-navbar-top" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '10px' }}>
          <div className="zx-brand" onClick={() => { setMobileMenuOpen(false); navigate('/landing') }} style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer', minWidth: 0 }}>
